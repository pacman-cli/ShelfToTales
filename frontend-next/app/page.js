        ...
        <div className="page-content bg-white">
                                        ...
                                        <SwiperSlide key={book.id || i}>
                                            <Link href={`/shop-detail/${book.id}`} className="hero-slide-inner">
                                                <div className="hero-slide-cover">
                                                    <img loading="lazy" decoding="async" src={book.coverUrl || `https://via.placeholder.com/300x420/${bookColors[i % bookColors.length].replace('#','')}/ffffff?text=${encodeURIComponent(book.title?.substring(0,10) || 'Book')}`} alt={book.title} />
                                                </div>
                    ...
                    <div className="row g-4">
                        {books.slice(0, 4).map((book, i) => (
                            <div className="col-lg-3 col-md-6" key={book.id || i}>
                                <Link href={`/shop-detail/${book.id}`} style={{textDecoration:'none'}}>
                                    <div className="stt-book-card">
                                        <div className="book-cover">
                                            <img loading="lazy" decoding="async" src={book.coverUrl || `https://via.placeholder.com/250x350/${bookColors[i].replace('#','')}/ffffff?text=${encodeURIComponent(book.title?.substring(0,10) || 'Book')}`} alt={book.title} />
            ...
            <section className="stt-community">
                <div className="container">
                    ...
                    <div className="text-center mt-5">
                        <Link href="/reader-network" className="stt-view-all">
