                            ...
                            <div className="row">
                                    ...
                                    <div className="rn-card">
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <div className="avatar-group d-flex">
                                                <img loading="lazy" decoding="async" src="https://i.pravatar.cc/150?u=a" alt="" className="rounded-circle border border-white" style={{width: '30px', height: '30px', marginRight: '-10px'}} />
                                                <img loading="lazy" decoding="async" src="https://i.pravatar.cc/150?u=b" alt="" className="rounded-circle border border-white" style={{width: '30px', height: '30px', marginRight: '-10px'}} />
                                ...
                                <div className="col-md-6 mb-4">
                                    <div className="rn-card">
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <div className="avatar-group d-flex">
                                                <img loading="lazy" decoding="async" src="https://i.pravatar.cc/150?u=c" alt="" className="rounded-circle border border-white" style={{width: '30px', height: '30px', marginRight: '-10px'}} />
                                                <img loading="lazy" decoding="async" src="https://i.pravatar.cc/150?u=d" alt="" className="rounded-circle border border-white" style={{width: '30px', height: '30px', marginRight: '-10px'}} />
                    ...
                    <div className="col-lg-4">
                        <div className="rn-friends-sidebar mt-5">
                            ...
                            <div className="friend-item">
                                <img loading="lazy" decoding="async" src="https://i.pravatar.cc/150?u=sarah" alt="" className="friend-avatar" />
                            ...
                            <div className="friend-item">
                                <img loading="lazy" decoding="async" src="https://i.pravatar.cc/150?u=marcus" alt="" className="friend-avatar" />
                                <div className="friend-info">
                                    <h6>Marcus V.</h6>
