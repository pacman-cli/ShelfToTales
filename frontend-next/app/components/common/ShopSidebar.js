        ...
        <>
            <div className="shop-filter">
                <div className="d-flex justify-content-between">
                    ...
                    <Link href={"#"} className="panel-close-btn"><i className="flaticon-close"></i></Link>
                </div>
                ...
                <Accordion className="accordion-filter accordion-inner" defaultActiveKey="0">
                    {accordionBlog2.map((data, index)=>(
                        <Accordion.Item eventKey={`${index}`}>
                            ...
                            <Accordion.Body>
                                 <ul>
                                    <li><Link href={"#"}>Alone Here</Link></li>
                                    <li><Link href={"#"}>Alien Invassion</Link></li>
                                    <li><Link href={"#"}>Bullo The Cat</Link></li>
                                    <li><Link href={"#"}>Cut That Hair!</Link></li>
                                    <li><Link href={"#"}>Dragon Of The King</Link></li>
                                </ul>              
                            </Accordion.Body>
                        </Accordion.Item>
                    ))}
                ...
                <div className="row filter-buttons">
                    <div>
                        <Link href={"#"} className="btn btn-secondary btnhover mt-4 d-block">Refine Search</Link>
                        <Link href={"#"} className="btn btn-outline-secondary btnhover mt-3 d-block">Reset Filter</Link>
                    </div>
                </div>
            </div>
