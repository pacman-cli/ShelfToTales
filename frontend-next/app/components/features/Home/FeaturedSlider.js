                    ...
                    <SwiperSlide key={ind}>                       
                        <div className="books-card style-2">
                            <div className="dz-media">
                                <img loading="lazy" decoding="async" src={item.coverUrl} alt="book" style={{width: '250px'}} />									
                            </div>
                            <div className="dz-content">
                                ...
                                <div className="bookcard-footer">
                                    <Link href={`/shop-detail/${item.id}`} className="btn btn-outline-secondary btnhover m-t15">See Details</Link>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
