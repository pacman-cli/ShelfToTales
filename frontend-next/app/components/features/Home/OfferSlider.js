...
//Images
const blog3 = '/assets/images/blog/blog5.jpg';
const blog5 = '/assets/images/blog/blog6.jpg';
const blog7 = '/assets/images/blog/blog7.jpg';
                    ...
                    <SwiperSlide key={ind}>                       
                        <div className="dz-card style-2">
                            <div className="dz-media">
                                <Link href={"/books-detail"}><img loading="lazy" decoding="async" src={item.image} alt="/" /></Link>
                            </div>
                            <div className="dz-info">
                                <h4 className="dz-title"><Link href={"/books-detail"}>{item.title}</Link></h4>
                                <div className="dz-meta">
                                    <ul className="dz-tags">
                                        <li><Link href={"/books-detail"} className="me-1">BIOGRAPHY</Link></li>
                                        <li><Link href={"/books-detail"} className="me-1">THRILLER</Link></li>
                                        <li><Link href={"/books-detail"} >HORROR</Link></li>
                                    </ul>
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                                <div className="bookcard-footer">
                                    <Link href={"/shop-cart"} className="btn btn-primary m-t15 btnhover btnhover2"><i className="flaticon-shopping-cart-1 m-r10"></i> Add to cart</Link>
