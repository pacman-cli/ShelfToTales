...
//Images
const wave = '/assets/images/testimonial/wave.png';
const test5 = '/assets/images/testimonial/testimonial5.jpg';
const test6 = '/assets/images/testimonial/testimonial6.jpg';
				...
				{clientData.map((d,i)=>(
					<SwiperSlide key={i}>	
                        <div className="testimonial-2">
                            ...
                            <img loading="lazy" decoding="async" src={wave} className="pattern" alt="/" />
                            <div className="testimonial-pic">
                                <img loading="lazy" decoding="async" src={d.image} alt="/" />
                            </div>
