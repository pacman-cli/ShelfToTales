...
const COMMUNITY_POSTS = [
  { id: 101, title: 'Why I Read 52 Books This Year', content: 'Setting a book-a-week challenge changed my life. Here\'s how I managed it while working full-time and raising two kids.', date: '2026-05-20', author: 'Sarah K.', avatar: 'https://ui-avatars.com/api/?name=Sarah+K&background=3b82f6&color=fff', likes: 89, comments: 23 },
  { id: 102, title: 'The Magic of Used Bookstores', content: 'There\'s something irreplaceable about wandering through dusty shelves and finding a forgotten gem. My favorite finds from independent bookshops around the world.', date: '2026-05-18', author: 'Marcus T.', avatar: 'https://ui-avatars.com/api/?name=Marcus+T&background=10b981&color=fff', likes: 56, comments: 14 },
  { id: 103, title: 'Book Club Tips for Introverts', content: 'You don\'t have to be outgoing to enjoy a book club. Here are strategies that helped me participate meaningfully without draining my social battery.', date: '2026-05-15', author: 'Priya M.', avatar: 'https://ui-avatars.com/api/?name=Priya+M&background=eaa451&color=fff', likes: 72, comments: 31 },
  { id: 104, title: 'From Reader to Writer: My Journey', content: 'After reading thousands of books, I finally wrote my own. The transition from consumer to creator taught me more about storytelling than any craft book ever could.', date: '2026-05-12', author: 'James L.', avatar: 'https://ui-avatars.com/api/?name=James+L&background=8b5cf6&color=fff', likes: 134, comments: 45 },
];
        ...
        {tab === 'feed' && (
          <div>
            ...
            {COMMUNITY_POSTS.map(post => (
              <div key={post.id} className="card border-0 shadow-sm mb-3" style={{borderRadius:16}}>
                <div className="card-body p-4">
                  <div className="d-flex align-items-center gap-3 mb-3">
                    <img src={post.avatar} alt="" className="rounded-circle" style={{width:40,height:40}}/>
                    <div>
                      <strong>{post.author}</strong>
                      <small className="text-muted d-block">{post.date}</small>
                    </div>
                  </div>
                  ...
                  <div className="d-flex gap-4 pt-2 border-top mt-3">
                    <button className="btn btn-sm btn-link text-muted text-decoration-none"><i className="fa-regular fa-heart me-1"/>{post.likes} Likes</button>
                    <button className="btn btn-sm btn-link text-muted text-decoration-none"><i className="fa-regular fa-comment me-1"/>{post.comments} Comments</button>
