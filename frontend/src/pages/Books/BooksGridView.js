                            ...
                            <div className="grid-area">
                                <div className="shop-tab">
                                    <ul className="nav text-center product-filter justify-content-end" role="tablist">
                                        ...
                                        <li className="nav-item">
                                            <Link to={"/books-grid-view"} className="nav-link active">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="dz-shop-card style-1">
                                        ...
                                        <div className="bookmark-btn style-2">
                                            <input className="form-check-input" type="checkbox" id={`flexCheckDefault${i+21}`}
                                                onChange={() => handleAddToWishlist(data.id)} />
                                        ...
                                        <div className="dz-content">
                                            ...
                                            <div className="book-footer">
                                                ...
                                                <button onClick={() => handleAddToCart(data.id)} className="btn btn-secondary box-btn btnhover btnhover2"><i className="flaticon-shopping-cart-1 m-r10"></i> Add to cart</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
